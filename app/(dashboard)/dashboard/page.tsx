  ...
  return (
    <div className="space-y-6">
      <div className="mb-8">
        ...
        <p className="text-gray-500 dark:text-gray-400">Real-time metrics for your API usage based on actual verification checks.</p>
      </div>
              ...
              return (
                <div key={i} className="w-full bg-gray-100 dark:bg-white/5 rounded-t-lg relative group h-full flex items-end">
                  <motion.div
                    ...
                    className="w-full absolute bottom-0 bg-primary/80 dark:bg-primary rounded-t-lg group-hover:bg-primary transition-colors min-h-[4px]"
                  />
      ...
      <div className="grid lg:grid-cols-2 gap-8 mt-6">
        {/* Safe Zone (Blue) */}
        <div className="p-10 rounded-[3rem] bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 shadow-xl group">
