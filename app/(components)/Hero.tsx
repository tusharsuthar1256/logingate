...
const Hero: React.FC<HeroProps> = ({ onStart }) => {
  return (
    <section className="relative pt-24 pb-16 md:pt-48 md:pb-40 px-4 sm:px-6 overflow-hidden flex flex-col items-center justify-center min-h-[90vh] md:min-h-[95vh] text-center">
      ...
      <div className="max-w-4xl mx-auto relative z-10 flex flex-col items-center">
        ...
        <motion.h1
          ...
          className="group cursor-default text-4xl xs:text-5xl md:text-7xl lg:text-8xl font-display font-bold text-gray-900 dark:text-white leading-[1.1] tracking-tight mb-6 sm:mb-8"
        >
        ...
        <motion.p
          ...
          className="text-base md:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mb-8 sm:mb-12 leading-relaxed px-2 sm:px-0"
        >
