...
const Pricing: React.FC<PricingProps> = ({ onSelectPlan }) => {
  ...
  return (
    <section id="pricing" className="py-24 px-6 bg-[#0A0A0B]/20 text-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {PRICING_PLANS.map((plan, index) => (
            <div
              key={index}
              className={`p-8 rounded-3xl relative border transition-all duration-300 ${plan.recommended
            ...
            >
              ...
              <button
                ...
                className={`w-full py-3 rounded-xl font-semibold transition-colors ${plan.recommended
